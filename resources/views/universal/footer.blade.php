    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-4 col-md-6 footer-contact d-flex justify-content-center">
          <img src="assets/img/exa-group/exa-group-logo-2.png" class="img-fluid"
            style="max-height: 150px; object-fit:contain;" alt="Examedia Group Logo">
        </div>
...
<div class=" d-md-flex py-4 d-flex justify-content-center" style="background: #ed1d29;">
  ...
  <div class="d-flex justify-content-center container">
    <div class="copyright" style="  text-align: center; color:#fff">
      Copyright &copy; 2023 <span>SQF Diversified Sdn Bhd</span>.
      {{-- Proudly made by Examedia Software. --}}
      All rights reserved.
    </div>
  </div>
</div>
